...
public class Maaj {
    ...
    public interface MeoAssistant extends StdCallLibrary {
        PointerByReference AsstCreate();

        boolean AsstConnect(PointerByReference handle, String adb, String host, String config);
    ...
    public static void main(String[] args) {
        ...
        PointerByReference pointer = instance.AsstCreate();
        boolean adb = instance.AsstConnect(pointer, "adb", "127.0.0.1:62001", "");
